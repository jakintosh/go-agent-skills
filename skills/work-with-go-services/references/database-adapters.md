...
- Read [store-contracts.md](store-contracts.md) for contract ownership and service-side translation rules.
- Read [`adapter-shape.md`](../../work-with-go-databases/references/adapter-shape.md) for the default database adapter shape.
- Read [`migrations.md`](../../work-with-go-databases/references/migrations.md) for schema change guidance.
- Read [`query-methods.md`](../../work-with-go-databases/references/query-methods.md) for read and write method shape.
- Read [`transactions.md`](../../work-with-go-databases/references/transactions.md) for multi-step database operations.
