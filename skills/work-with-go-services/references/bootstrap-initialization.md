...
- [Required](#required)
- [When to add explicit initialization](#when-to-add-explicit-initialization)
- [Canonical flow](#canonical-flow)
- [Initialization method shape](#initialization-method-shape)
- [Declared bootstrap constants](#declared-bootstrap-constants)
