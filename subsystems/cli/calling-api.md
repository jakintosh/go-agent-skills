...
`wire.Client` automatically joins the base URL and path, sends bearer auth when `APIKey` is set, decodes the standard wire envelope, and returns API error messages as Go errors.
