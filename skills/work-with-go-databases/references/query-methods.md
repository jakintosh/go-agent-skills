...
- [Read method shape](#read-method-shape)
- [Row iteration shape](#row-iteration-shape)
- [Null and conversion handling](#null-and-conversion-handling)
- [Write, update, and upsert shape](#write-update-and-upsert-shape)
