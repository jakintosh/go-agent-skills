...
- [Why to upgrade from SQL strings](#why-to-upgrade-from-sql-strings)
- [Refactoring the migration type](#refactoring-the-migration-type)
- [Refactoring the runner](#refactoring-the-runner)
