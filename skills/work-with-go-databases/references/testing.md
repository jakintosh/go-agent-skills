...
- [Package and file shape](#package-and-file-shape)
- [Setup strategy](#setup-strategy)
- [Test helper boundary](#test-helper-boundary)
- [Seeding policy](#seeding-policy)
- [Canonical flow](#canonical-flow)
- [Canonical example](#canonical-example)
- [Open and migration coverage](#open-and-migration-coverage)
- [Query and transaction coverage](#query-and-transaction-coverage)
