...
- [Test Composition Root](#test-composition-root)
...
If production wiring and test wiring need to diverge more deeply, read [server composition roots](../../work-with-go-servers/references/composition-roots.md).
