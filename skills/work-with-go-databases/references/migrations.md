...
- If a migration needs reads, batching, or conditional steps, read [migrations-with-go.md](./migrations-with-go.md).
...
If that happens, read [migrations-with-go.md](./migrations-with-go.md).
...
For procedural migration bodies, read [migrations-with-go.md](./migrations-with-go.md). For open behavior, schema readiness, and version advancement, read [testing.md](./testing.md).
